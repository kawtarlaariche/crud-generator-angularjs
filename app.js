...
/*fs.writeFile(path + "/" +'list.html', fileUtil.beautifyHtml(htmlListGenerator.generate(list[i],[
        {attr: 'nom', type: Datatypes.TEXT}, 
        {attr: 'age', type: Datatypes.NUMBER}, 
        {attr: 'createdAt', type: Datatypes.DATE}        
       ])),
...
fs.writeFile(path + "/" +'edit.html', fileUtil.beautifyHtml(htmlEditGenerator.generate(list[i],[
    {attr: 'nom', type: Datatypes.TEXT}, 
    {attr: 'age', type: Datatypes.NUMBER}, 
    {attr: 'createdAt', type: Datatypes.DATE}        
   ])),
